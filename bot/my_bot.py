...
def hashtag_keyboards(update: Update, context: ContextTypes) -> None:
    ...
    keyboard = [[InlineKeyboardButton(hashtag['hashtag'], callback_data=hashtag['hashtag'])] for hashtag in most_hashtags]
...
def my_hashtag_keyboards(update: Update, context: ContextTypes) -> None:
    ...
    keyboard = [[InlineKeyboardButton(hashtag, callback_data='my' + hashtag)] for hashtag in user_hashtags]
